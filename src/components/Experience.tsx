...
const experience: Experience[] = [
  ...
  },
  {
    ...
    position: "Senior Software Engineer",
    description:
      "Serving as a Senior Software Engineer responsible for designing, building, and maintaining enterprise-grade web applications. The role involves end-to-end ownership of backend architecture, system reliability, and performance, while collaborating with cross-functional teams to deliver scalable, secure, and business-aligned solutions.",
    highlights: [
      "Develop and maintain applications using secure, maintainable coding practices.",
      "Support architecture and design discussions; act as bridge between Developer and Senior Technical Lead responsibilities.",
      "Review and refine technical specifications.",
      "Act as mentor for Developers and assist Lead in coordinating development tasks.",
      "Participate in code reviews and contribute to coding standards.",
      "Collaborate with QA during test cycles and support release activities.",
  ...
  },
  {
    ...
    description:
      "Worked as a Software Engineer contributing to the design and development of a large-scale courier and logistics management platform. The role involved building backend services, integrating third-party systems, implementing location-based features, and ensuring system scalability and performance for high-volume operational workflows.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Contributed to production web applications while gaining hands-on industry experience.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Completed structured professional training focused on enterprise web application development.",
    highlights: [
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-block bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl px-8 py-6 shadow-md border border-blue-200">
            ...
            <p className="text-4xl font-bold text-blue-600">
              {totalExp.years}+{" "}
              <span className="text-2xl text-gray-700">Years</span>
            </p>
            {totalExp.months > 0 && (
              <p className="text-sm text-gray-600 mt-2">
                {totalExp.years} years {totalExp.months} month
                {totalExp.months !== 1 ? "s" : ""}
              </p>
            )}
          </div>
                    ...
                    <div className="flex flex-wrap gap-4 text-gray-600 mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold ml-2">
                          {calculateYears(exp.start_date, exp.end_date)} year
                          {calculateYears(exp.start_date, exp.end_date) !== 1
                            ? "s"
                            : ""}
                        </span>
                      </div>
